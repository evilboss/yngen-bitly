        ...
        return (
            <div>
                <nav className="navbar navbar-default">
                    <div className="container-fluid">
                        <div className="navbar-header">
                            <a className="navbar-brand" href="#">Yngen exam - REST API to URL Shortener web application
                                page</a>
                        </div>
                ...
                <div className="jumbotron">
                    <h1>REST API to URL Shortener

                        Development Task for node.js

                    </h1>
                    <p>This example is a quick exercise to illustrate how the default, static navbar and fixed to top
                        navbar work. It includes the responsive CSS and HTML, so it also adapts to your viewport and
                        device.</p>
                    <p>
                    ...
                    <ul>
                        ...
                        <li><span>Make sure to wrap the functionality of communicating with bitly, in a class.</span>
                        </li>
                        <li>
